...
export const BUILDINGS: BuildingDef[] = [
  {
    ...
    kind: 'producer',
    name: 'Буровой дрон',
    description: 'Добывает 0,5 руды/с',
    rate: 0.5,
    baseCost: { ore: 15 },
  },
  {
  ...
  },
  {
    ...
    description: 'Собирает 1 чип/с из 5 сплава/с',
    input: 'alloy',
    output: 'chip',
    inputRate: 5,
    outputRate: 1,
  ...
  },
  {
    ...
    description: 'Добывает 40 руды/с',
    rate: 40,
  ...
  },
  {
    ...
    description: 'Обучает 0,5 ядра/с на 10 чипах/с',
    input: 'chip',
    output: 'core',
    inputRate: 10,
    outputRate: 0.5,
