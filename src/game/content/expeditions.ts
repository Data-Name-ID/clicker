...
export const EXPEDITION_KINDS: ExpeditionKindDef[] = [
  { kind: 'short', name: 'Разведка', durationSec: 15 * 60, rewardScale: 1.5 },
  { kind: 'long', name: 'Вылазка', durationSec: 60 * 60, rewardScale: 2 },
  { kind: 'deep', name: 'Дальний рейд', durationSec: 4 * 60 * 60, rewardScale: 3 },
]
